...
/**
 * 创建者     叶庆荣
 * 创建时间   2016/5/14 22:40
 * 描述	      HotMessageAdapter
 * <p/>
 * 更新者     $Author$
 * 更新时间   $Date$
 * 更新描述   ${TODO}
 */
public class TweetsNewsMessageAdapter extends BaseAdapter {
     ...
     * @param newsList
     */
    public void setData(List<Tweet> newsList) {
        mTweetslist.addAll(newsList);
        notifyDataSetChanged();
    }
