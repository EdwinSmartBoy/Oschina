 ...
 * 更新描述   ${TODO}
 */
public class ZMessageFragment extends BaseListFragment {
    ...
    protected BaseAdapter getListAdapter() {
        return new MyBlogAdapter();
    }

    @Override
    protected void requestData() {
        ApiService.getTopic(mRequestQueue, listener, 4);
    }
    ...
    protected void updateUI(Object obj) {
        ...
        ((MyBlogAdapter) baseListAdapter).updateData(list);
    }
