 ...
 */
public class ZHRecommendFragment extends BaseListFragment {
    ...
    protected void requestData() {
        ApiService.getRecommendList(mQueue,listener,0);

    }

    @Override
    protected Object parseData(String data) {
        mBlogList = XmlUtils.toBean(BlogList.class, data.getBytes());
        System.out.print(mBlogList.getList().get(1).getTitle());
        return mBlogList;
    }
    ...
    protected void updateUI(Object obj) {
        ...
        List<Blog> list = blogList.getList();
